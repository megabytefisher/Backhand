...
namespace Backhand.DeviceIO.Usb
{
    public static class UsbDeviceConfigs
    {
        ...
        {
            new UsbDeviceConfig(0x081E, 0xDF00, "AlphaSmart Dana", UsbDeviceHandshakeType.New),
            new UsbDeviceConfig(0x082D, 0x0100, "HandSpring Visor", UsbDeviceHandshakeType.None, UsbProtocolType.Slp)
        };
